...
local function install_palette(p)
  require("tokyonight.colors").styles.matugen = function()
    ...
    return vim.tbl_deep_extend("force", base, {
      ...
      -- Material roles remain the anchors; contrary supplies the native
      -- source -60 degree spoke where TokyoNight needs one more accent.
      blue = p.primary,
      blue0 = p.primary_container,
      blue1 = p.secondary,
      blue2 = p.primary,
      blue5 = p.secondary_fixed_dim,
      blue6 = p.contrary,
      blue7 = p.tertiary_container,
      cyan = p.secondary,
      green = p.tertiary,
      green1 = p.syntax_yellow,
      green2 = p.tertiary,
      magenta = p.tertiary_fixed_dim,
      magenta2 = p.syntax_red,
      orange = p.contrary,
      purple = p.secondary,
      red = p.error,
      red1 = p.error,
