...
-- hl.dsp.window.fullscreen() 在当前版本 API 中未确认，使用 hyprctl 兜底
...
-- 注：toggle_layout.sh 用 sed 修改 .conf，切换到 Lua 配置后需要更新该脚本
...
hl.bind(mainMod .. " + SHIFT + T", hl.dsp.layout("consume_or_expel"))
